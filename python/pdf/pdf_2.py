...
def update_page_text_hash (h, lt_obj, pct=1):
...
def parse_lt_objs (lt_objs, page_number, images_folder, text=[]):
    ...
    for lt_obj in lt_objs:
        print("isinstance(lt_obj, LTTextBox)",isinstance(lt_obj, LTTextBox))
        print("isinstance(lt_obj, LTTextLine)", isinstance(lt_obj, LTTextLine))
